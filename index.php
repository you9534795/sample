<?php
define('BASE_URL', 'http://ysd123f.php.xdomain.jp');
?>
<!DOCTYPE html>
<html lang="ja">
  <head>
    ...
    <meta name="keywords" content="看護,看護師,仮眠,夜勤,ナース,計算,仮眠計算,休憩時間"/><meta property="og:url" content="<?= BASE_URL; ?>/" />
    ...
    <meta property="og:image" content="<?= BASE_URL; ?>/common/img/ogp/ogp.jpg" />
      ...
      <main class="main">
        <div class="container">
          <div class="mainContent">
            <div class="noticeBox">
              <div class="_row">
                <div class="noticeBox_date">2022.05.25</div>
                <div class="noticeBox_text">URLが変わりました。このサイトをブックマークしてください。</div>
              </div>
            </div>
          ...
          <div class="_foot_banner" style="margin: 2em 0;">
            <a href="https://www.instagram.com/i_am_mugi0710/" onclick="gtag('event', 'tap', {'event_category':'banner','event_label':'インスタバナー'} );" class="on_opacity" target="_blank" style="display: table;margin: auto;max-width: 280px;border: solid 2px #003366;border-radius: 50px;overflow: hidden;position: relative;background: #fff;padding: 0em;"><img src="mugi.jpg" alt="" loading="lazy"></a>
          </div>
        </div>
      </main>
      <footer class="footer">
        <div class="container">
          <div class="footer_1">
            <div class="line-it-button" data-lang="ja" data-type="share-a" data-ver="3" data-url="<?= BASE_URL; ?>/" data-color="default" data-size="small" data-count="false" style="display: none;"></div>
            <script src="https://d.line-scdn.net/r/web/social-plugin/js/thirdparty/loader.min.js" async="async" defer="defer"></script>
          </div>
          <div class="footer_2">
            <div class="footer_copy">copyright&copy; Mugi 2021.</div>
          </div>
        </div>
      </footer>
    </div>
